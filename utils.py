...
class temp(object):
    ...
    start_btns = [
        [
            ikb('🎥 Netflix', url=f'http://t.me/dublajflix'),
            ikb('🎬 Film', url=f'http://t.me/hdfilmmerkezi')
        ],
        [   ikb('💻 Disney', url=f'http://t.me/+45RLiFC87d45MGNk'),
            ikb('🔗 Reklam Geçme', url=f'http://t.me/kisalinkgecmek')
        ],
        [
            ikb('❓ Hakkında', callback_data='about'),
            ikb('⚙️ Ayarlar', callback_data='settings#0')
        ]
    ]
